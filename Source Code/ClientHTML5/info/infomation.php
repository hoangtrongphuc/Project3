<table id="info-table" width="500" border="0" cellspacing="20">
			<tr><h2 style="padding:30px;">Thông tin chung</h2></tr>
          <tr>
      ...
      <p class="form-control-static">nghiait0111</p>
          ...
          <tr>
          <td></td>
          <td><a href="#"><button style="width:240px;" type="button" class="btn btn-success" name="submit" id="submit">Thay đổi thông tin cá nhân</button></a></td>
          </tr>
